...
class FavoriteButton extends StatefulWidget {
  ...
  final double height;
  final double width;
  const FavoriteButton({super.key, required this.foodIndex, required this.height, required this.width});
...
class _FavoriteButtonState extends State<FavoriteButton> {
  ...
  Widget build(BuildContext context) {
    return CustomSecondaryButton(
      ...
      iconData: food[widget.foodIndex].isFavorite ? Icons.favorite : Icons.favorite_border,
    );
  }
}
